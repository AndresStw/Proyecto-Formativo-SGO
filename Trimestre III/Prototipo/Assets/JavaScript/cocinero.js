document.addEventListener("DOMContentLoaded", () => {
    ...
    if (nombreCocinero) nombreCocinero.textContent = usuario.nombre || "Cocinero";
    ...
    let pedidos = [
        { id: 1, mesa: "Mesa 3", hora: "12:05 PM", platos: ["1 Hamburguesa ", "1 Papas a la francesa", "1 Limonada"], nota: "Sin cebolla", estado: "pendiente" },
        { id: 2, mesa: "Mesa 7", hora: "12:10 PM", platos: ["2 Pizza familiar", "1 Gaseosa 1.5L"], nota: "", estado: "pendiente" },
        { id: 3, mesa: "Domicilio", hora: "12:14 PM", platos: ["1 Bandeja paisa", "1 Jugo de mora"], nota: "Entregar en bolsa sellada", estado: "pendiente" },
        { id: 4, mesa: "Mesa 1", hora: "11:50 AM", platos: ["1 Ensalada César", "1 Agua con gas"], nota: "", estado: "listo" }
    ];
    function renderPedidos() {
        ...
        pedidos.forEach(pedido => {
            ...
            const listaPlatos = pedido.platos.map(plato => `<li>${plato}</li>`).join("");
            ...
            card.innerHTML = `
                ...
                <span class="badge-estado ${estaListo ? "listo" : "pendiente"}">${estaListo ? "Listo" : "Pendiente"}</span>
                ...
                <button class="btn-listo" onclick="marcarComoListo(${pedido.id})" ${estaListo ? "disabled" : ""}>
